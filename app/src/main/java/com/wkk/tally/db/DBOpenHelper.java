...
public class DBOpenHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(sql);
        insertType(db);
        sql = "create table accounttb(id integer primary key autoincrement, typename varchar(10), sImageId integer, beizhu varchar(80)" +
    ...
    private void insertType(SQLiteDatabase db) {
        ...
        db.execSQL(sql, new Object[]{"水电气", R.mipmap.ic_shuidianfei, R.mipmap.ic_shuidianfei_fs, 0});
